...
--> statement-breakpoint
ALTER TABLE `users` MODIFY COLUMN `role` enum('owner','doctor','patient','admin') NOT NULL DEFAULT 'patient';--> statement-breakpoint
ALTER TABLE `users` ADD `phone` varchar(20);--> statement-breakpoint
ALTER TABLE `users` ADD `specialization` varchar(255);--> statement-breakpoint
ALTER TABLE `users` ADD `licenseNumber` varchar(255);--> statement-breakpoint
ALTER TABLE `users` ADD `clinicName` varchar(255);--> statement-breakpoint
ALTER TABLE `users` ADD `clinicAddress` text;--> statement-breakpoint
ALTER TABLE `users` ADD `isOwner` boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE `users` ADD `ownerEmail` varchar(320) DEFAULT 'mhm763517@gmail.com';--> statement-breakpoint
ALTER TABLE `users` ADD `isVerified` boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE `users` ADD `appTitle` varchar(255) DEFAULT 'نظام إدارة العيادة';--> statement-breakpoint
ALTER TABLE `users` ADD `appLogo` text;--> statement-breakpoint
ALTER TABLE `users` ADD `primaryColor` varchar(7) DEFAULT '#0066cc';--> statement-breakpoint
ALTER TABLE `users` ADD `secondaryColor` varchar(7) DEFAULT '#00cc99';--> statement-breakpoint
ALTER TABLE `users` ADD `welcomeMessage` text DEFAULT ('أهلاً وسهلاً في عيادتنا');--> statement-breakpoint
